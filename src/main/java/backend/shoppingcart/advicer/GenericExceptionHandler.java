package backend.shoppingcart.advicer;
...
import backend.shoppingcart.dto.exception.ResponseErrorDto;
...
public class GenericExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    private final ResponseEntity<Object> 
        handlerGenericException(GenericException ex, WebRequest request, BaseErrorDto baseError) {
    ...
    customResponseFromException(GenericException ex, 
        WebRequest request,  BaseErrorDto baseError) {   
    ...
    public ResponseEntity<Object> exception(GenericException ex, WebRequest request) {
        var baseError = BaseErrorDto.builder()
        .field("Exception")
