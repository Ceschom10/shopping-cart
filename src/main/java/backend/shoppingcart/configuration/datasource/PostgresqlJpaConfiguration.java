package backend.shoppingcart.configuration.datasource;
...
@EnableJpaRepositories(basePackages = {"backend.shoppingcart" }, 
...
public class PostgresqlJpaConfiguration {
	...
	public LocalContainerEntityManagerFactoryBean postgressqlEntityManagerFactory(
		...
		return builder.dataSource(dataSource).properties(props).packages("backend.shoppingcart").build();
	}
